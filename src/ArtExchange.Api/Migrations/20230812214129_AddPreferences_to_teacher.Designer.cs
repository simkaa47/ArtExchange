...
namespace ArtExchange.Api.Migrations
{
    ...
    [Migration("20230812214129_AddPreferences_to_teacher")]
    partial class AddPreferences_to_teacher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtExchange.Domain.Entities.Address", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ArtExchange.Domain.Entities.Event", b =>
                {
                    b.HasOne("ArtExchange.Domain.Entities.EventPlace", "Place")
                        .WithMany()
            ...
            modelBuilder.Entity("ArtExchange.Domain.Entities.EventPlace", b =>
                {
                    b.HasOne("ArtExchange.Domain.Entities.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("ArtExchange.Domain.Entities.Student", b =>
                {
                    b.HasOne("ArtExchange.Domain.Entities.Person", "Person")
                        .WithMany()
            ...
            modelBuilder.Entity("EventStudent", b =>
                {
                    b.HasOne("ArtExchange.Domain.Entities.Event", null)
                        .WithMany()
                        .HasForeignKey("EventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ArtExchange.Domain.Entities.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventTeacher", b =>
                {
                    ...
                    b.HasOne("ArtExchange.Domain.Entities.Teacher", null)
                        .WithMany()
