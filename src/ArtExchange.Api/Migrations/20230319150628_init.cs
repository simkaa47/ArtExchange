        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventsPlaces_Addresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxStudentsCount = table.Column<int>(type: "integer", nullable: false),
                    MinStudenstsCount = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_EventsPlaces_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "EventsPlaces",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventTeacher", x => new { x.EventsId, x.TeachersId });
                    table.ForeignKey(
                        name: "FK_EventTeacher_Events_EventsId",
                        column: x => x.EventsId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventTeacher_Teachers_TeachersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventsPlaces_AddressId",
                table: "EventsPlaces",
                column: "AddressId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventTeacher_TeachersId",
                table: "EventTeacher",
                column: "TeachersId");
